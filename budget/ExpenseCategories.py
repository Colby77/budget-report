...
def main():
    ...
    print(timeit.timeit(stmt = "expenses.categorize_for_loop()",setup = setup_str,number=100000,globals=globals()))
    print(timeit.timeit(stmt = "expenses.categorize_set_comprehension()",setup = setup_str,number=100000,globals=globals()))
